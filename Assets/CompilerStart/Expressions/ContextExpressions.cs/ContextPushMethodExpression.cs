...
{
    public class ContextPushMethodExpression : IExpression
    {
        IExpression zone;
        IExpression parameterExp;
        Scope scope;
        public ContextPushMethodExpression(IExpression Zone, IExpression ParameterExp, Scope Scope)
        {
            zone = Zone;
        ...
        public GwentObject Evaluate()
        {
            ...
            CompilerCard setCard = manager.PushCard(CompCard, ZoneOb);
